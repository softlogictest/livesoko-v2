// LiveSoko — Google Apps Script
// Attach to your Google Form via Extensions > Apps Script
// Trigger: onFormSubmit (Form Submit event)
// ============================================================

const LIVESOKO_URL = "https://YOUR_APP.up.railway.app/api/orders"; // Your Production or Local URL
const WEBHOOK_TOKEN = "YOUR_WEBHOOK_TOKEN_HERE"; // From LiveSoko Settings tab
...
function onFormSubmit(e) {
  ...
  try {
    const res = UrlFetchApp.fetch(LIVESOKO_URL, {
      method: "post",
      contentType: "application/json",
      payload: JSON.stringify(payload),
      muteHttpExceptions: true
    });
    Logger.log("LiveSoko response: " + res.getResponseCode() + " — " + res.getContentText());
  } catch (err) {
    Logger.log("LiveSoko error: " + err.toString());
  }
}
