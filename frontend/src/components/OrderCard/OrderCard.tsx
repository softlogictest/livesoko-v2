      ...
      >
        ...
        <div className="flex justify-between items-end">
          ...
          <div className="flex gap-3">
            ...
            <a href={`https://wa.me/${order.buyer_phone && order.buyer_phone.replace('+', '')}?text=Hi, I placed an order on LiveSoko. Please confirm delivery details.`} target="_blank" rel="noreferrer" onClick={e => e.stopPropagation()} className="p-2 rounded-full bg-bg-elevated text-[#25D366]">
              💬
            </a>
          </div>
        </div>
